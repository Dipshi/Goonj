					...
					<div class="product-details"><!--product-details-->
						<div class="col-sm-5">
							<div class="view-product">
								<img src="{{URL::to('images/home/toy.jpg')}}" alt="">
								<h3>ZOOM</h3>
							</div>
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								<img src="images/product-details/{{ $query[0]->images}}.jpg" class="newarrival" alt="" />
								<h2>{{ $query[0]->item_name }}</h2>
								<p>Web ID: {{ $query[0]->item_id }}</p>
								<img src="images/product-details/rating.png" alt="" />
								<span>
									<span>Rs.{{ $query[0]->cost}}</span>
								...
								<p><b>Category:</b> {{ $query[0]->category}}</p>
