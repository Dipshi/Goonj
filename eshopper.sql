...
CREATE TABLE `customer` (
  ...
  `mobile_number` int(10) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
('ISHA', 'SHETTY', 'cu101', '2015isha.shetty@ves.ac.in', 'omkar soc', 421202, 63425424),
...
INSERT INTO `orders` (`oid`, `item_id`, `cid`, `qty`) VALUES
(6, 'i_101', 'cu101', 4),
(7, 'i_103', 'cu101', 3),
(8, 'i_101', 'cu101', 4),
(9, 'i_103', 'cu101', 3),
